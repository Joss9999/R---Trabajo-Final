...
use "K:\DPEM\2. Base de datos y Consultas\Empleo\Empleo - Base de datos\Enaho\enaho01a1-2017-500.dta", clear
set more off
...
g sectortrab=.
replace sectortrab=1 if ciiu4==1 | ciiu4==2
...
************TIPO DE CONTRATO*******************************************************************************************
g tco= .
replace tco = 1 if p511a == 1
replace tco=  2 if p511a == 2
replace tco=  3 if p511a == 3 |  p511a == 4    |  p511a == 5     |     p511a == 6        | p511a == 7 |  p511a == 8

 
label variable tco "Tipo de Contrato"
label define tco  1 "Indefinido"  2 " Plazo fijo" 3 "Resto" 
label values tco tco
